...
enum ProcessRequestEnum {
    preqProcessError = -1,
    preqProcessNone = 0,
    preqProcessStatus,
    preqProcessStatusMX2,
    preqProcessSpectrum,
    preqProcessScopeData,
    preqProcessTextData,
    preqProcessScopeDataOverFlow,
    preqProcessInetSettings,
    preqProcessDiagData,
    preqProcessHwDesc,
    preqProcessCfgRead,
    preqProcessNetFindRead,
	preqProcessPaCal,
    preqProcessSCAData,
    preqProcessAck,
    preqProcessRequestPacket,
    preqProcessTubeInterlockTableMX2,
    preqProcessWarmupTableMX2,
    preqProcessTimestampRecordMX2,
    preqProcessFaultRecordMX2
};
