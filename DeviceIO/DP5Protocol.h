...
enum PID2_REQ_SCOPE_MISC_TYPE {               //PID1_REQ_SCOPE_MISC = 0x03
...
enum PID2_REQ_CONFIG_TYPE {            //PID1_REQ_CONFIG = 0x20
...
enum PID2_VENDOR_REQ_TYPE {            //PID1_VENDOR_REQ = 0xF0
    PID2_CLEAR_SPECTRUM = 0x01,
    ...
    //----------------------------------------------------------------
    PID2_WRITE_MX2_TUBE_ILOCK_TABLE = 0x30,    //Mini-X2 Only Functions
    PID2_WRITE_MX2_TIMESTAMP = 0x31,
    PID2_WRITE_MX2_WARMUP_SEQUENCE = 0x32,
    PID2_INIT_MX2_WARMUP_SEQUENCE = 0x33,

	PID2_GENERIC_FPGA_WRITE = 0x89
};  //PID2_VENDOR_REQ_TYPE

enum PID2_REQ_COMM_TEST {                 //PID1_COMM_TEST = 0xF1
    PID2_REQ_COMM_ACK_OK = 0x00,
    PID2_REQ_COMM_ACK_SYNC_ERROR = 0x01,
    PID2_REQ_COMM_ACK_PID_ERROR = 0x02,
    PID2_REQ_COMM_ACK_LEN_ERROR = 0x03,
    PID2_REQ_COMM_ACK_CHECKSUM_ERROR = 0x04,
    PID2_REQ_COMM_ACK_BAD_PARAM = 0x05,
    PID2_REQ_COMM_ACK_BAD_HEX_REC = 0x06,
    PID2_REQ_COMM_ACK_UNRECOG = 0x07,
    PID2_REQ_COMM_ACK_FPGA_ERROR = 0x08,
    PID2_REQ_COMM_ACK_CP2201_NOT_FOUND = 0x09,
    PID2_REQ_COMM_ACK_SCOPE_DATA_NOT_AVAIL = 0x0A,
    PID2_REQ_COMM_ACK_PC5_NOT_PRESENT = 0x0B,
    PID2_REQ_COMM_ACK_OK_ETHERNET_SHARE_REQ = 0x0C,
    PID2_REQ_COMM_ACK_ETHERNET_BUSY = 0x0D,
    PID2_REQ_COMM_ACK_I2C_ERROR = 0x0E,
    PID2_REQ_COMM_ACK_OK_FPGA_ADDRESS = 0x0F,
    PID2_REQ_COMM_ECHO_PACKET = 0x7F
}; //PID2_REQ_COMM_TEST

enum PID2_RCV_STATUS_TYPE {                //PID1_RCV_STATUS = 0x80
    RCVPT_DPP_STATUS = 0x01,
    RCVPT_MX2_STATUS = 0x02
...
enum PID2_RCV_SCOPE_MISC_TYPE {
    ...
    //--------------------------------------------------------------
    RCVPT_MX2_TUBE_ILOCK_TABLE = 0x0D,        //Mini-X2 Only Functions
